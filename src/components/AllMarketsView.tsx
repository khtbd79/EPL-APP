...
export const AllMarketsView: React.FC<AllMarketsViewProps> = ({ state, onNavigateTab }) => {
  ...
  return (
    <div className="space-y-6 animate-fadeIn pb-16">
      ...
      {/* Grid of All Markets Cards or Empty State */}
      {totalMatchesCount === 0 ? (
        <div className="bg-white rounded-3xl p-12 border border-slate-200 text-center space-y-3 shadow-xs">
          ...
          {onNavigateTab && (
            <button
              ...
              className="mt-2 inline-flex items-center space-x-1.5 px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-xs font-bold rounded-xl transition-all cursor-pointer shadow-xs"
            >
              <span>Go to Team Data</span>
            ...
            <div className="bg-white rounded-3xl p-5 sm:p-6 border border-slate-200 shadow-sm space-y-4">
              ...
              {activeMarket.weeklyPoints.length === 0 ? (
                <div className="py-8 text-center text-xs font-bold text-slate-400">
                  No weekly match records available.
                </div>
              ) : (
